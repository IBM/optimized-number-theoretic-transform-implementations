...
IF(CLANG_FORMAT)
  ...
  if(${CLANG_FORMAT_MAJOR_VERSION} LESS "9")
    ...
    file(GLOB_RECURSE CF_FILES1 ${SRC_DIR}/*.c)
    file(GLOB_RECURSE CF_FILES2 ${INCLUDE_DIR}/*.h ${INCLUDE_DIR}/internal/*.h)
    file(GLOB_RECURSE CF_FILES3 ${TESTS_DIR}/*.c ${TESTS_DIR}/*.h)
    set(FILES_TO_FORMAT "${CF_FILES1}" "${CF_FILES2}" "${CF_FILES3}")
