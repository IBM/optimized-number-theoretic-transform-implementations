...
static inline void LoadFwdInterleavedT1(const uint64_t* arg, __m512i* out1,
                                 __m512i* out2) {
  const __m512i* arg_512 = (const __m512i*)(arg);
...
static inline void LoadInvInterleavedT1(const uint64_t* arg, __m512i* out1,
                                 __m512i* out2) {
...
static inline void LoadFwdInterleavedT2(const uint64_t* arg, __m512i* out1,
                                 __m512i* out2) {
  const __m512i* arg_512 = (const __m512i*)(arg);
...
// *out1 =  _mm512_set_epi64(14, 12, 10, 8, 6, 4, 2, 0);
// *out2 =  _mm512_set_epi64(15, 13, 11, 9, 7, 5, 3, 1);
static inline void LoadInvInterleavedT2(const uint64_t* arg, __m512i* out1,
                                 __m512i* out2) {
  const __m512i* arg_512 = (const __m512i*)(arg);
...
static inline void LoadFwdInterleavedT4(const uint64_t* arg, __m512i* out1,
                                 __m512i* out2) {
  const __m512i* arg_512 = (const __m512i*)(arg);
...
static inline void LoadInvInterleavedT4(const uint64_t* arg, __m512i* out1,
                                 __m512i* out2) {
  const __m512i* arg_512 = (const __m512i*)(arg);
...
//               12, 4, 13, 5, 14, 6, 15, 7}
static inline void WriteFwdInterleavedT1(__m512i arg1, __m512i arg2, __m512i* out) {
  const __m512i vperm2_idx = _mm512_set_epi64(3, 2, 1, 0, 7, 6, 5, 4);
...
//               12, 13, 14, 15, 4, 5, 6, 7}
static inline void WriteInvInterleavedT4(__m512i arg1, __m512i arg2, __m512i* out) {
...
static inline __m512i LoadWOpT2(const void* arg) {
  const __m512i vperm_w_idx = _mm512_set_epi64(3, 3, 2, 2, 1, 1, 0, 0);

  __m256i v_W_256 = _mm256_loadu_si256((const __m256i*)(arg));
...
static inline __m512i LoadWOpT4(const void* arg) {
  const __m512i vperm_w_idx = _mm512_set_epi64(1, 1, 1, 1, 0, 0, 0, 0);

  __m128i v_W_128 = _mm_loadu_si128((const __m128i*)(arg));
